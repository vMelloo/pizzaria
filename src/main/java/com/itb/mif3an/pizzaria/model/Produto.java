...
public class Produto {
   ...
   // Encapsulamento : proteger meus aributos do aceso desordenado, pode estar ligado
    //  ás questões de validação

    // Para obter o encapsulamento temos que seguir alguns passos:

    // 1º Passo: Trabalhar os modifcadores de acesso
    // Temos três:
    // public -> Acesso livre para todas as classes
    // private -> Acesso permitido apenas dentro da classe
    // protected -> Acesso permitido apenas para as classes filha (Herança)
